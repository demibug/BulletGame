...
// using GameData;
// using GameNetwork.BestWebSocket;
// using Protos;
// using TEngine;
//
// namespace GameNetwork
// {
//     public partial class NetworkChannelBestWebSocket : NetworkChannelBase
//     {
//         private BwsClient m_client;
...
//
//         public NetworkChannelBestWebSocket(string name) : base(name)
//         {
...
//         public override void Notify(int routeId, object msg)
//         {
//             if (ClientIsValid())
//             {
//                 m_client.Notify(routeId, msg);
//             }
//         }
//
//
...
//             }
//
//             ResponePack<TRespone> responePack = ResponePack<TRespone>.Create(action, null);
...
//
//             Request<RespSyncTime>(105, req, OnSyncServerTime);
//             // GameBase.GameLog.LogColor($"Request heart beat 105 : ", req, Color.green, Color.white);
//             return true;
//         }
//
...
//             if (msg != null)
//             {
//                 // GameBase.GameLog.LogColor($"Request heart beat 105 : ", msg, Color.cyan, Color.white);
...
//         // }
//
//         public override void Request<TRespone>(string route, object msg, Action<TRespone> action)
//         {
//         }
//
