...
// {
//     public class BwsByteBuffer
//     {
//         public static BwsByteBuffer RequestByteBuffer(int routeId, uint reqUid, byte[] data)
//         {
//             // size : 【协议号， 长度， rid, 数据】
//             uint dataLen = (uint)(BwsDefines.ReqUidLen + data.Length);
//             long size = BwsDefines.ReqUidLen + data.Length;
//             byte[] bytes = BufferPool.Get(size, false);
//             BwsByteBuffer byteBuffer = new BwsByteBuffer();
//             byteBuffer.buffer = bytes;
//
//             // byteBuffer.WriteInt(routeId);
//             // byteBuffer.WriteUint(dataLen);
//             byteBuffer.WriteUint(reqUid);
//             byteBuffer.WriteBytes(data);
//
//             return byteBuffer;
//         }
//
//         public static BwsByteBuffer ResponseByteBuffer(byte[] data)
//         {
//             BwsByteBuffer byteBuffer = new BwsByteBuffer();
