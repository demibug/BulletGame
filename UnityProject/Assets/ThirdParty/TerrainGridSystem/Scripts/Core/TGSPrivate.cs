            ...
            if (cameraMain == null) {
                ...
                if (cameraMain == null || (cameraMain.cullingMask & gameObjectLayerMask) == 0) {
                    ...
                    if (cams.Length == 0) {
                        ...
                        if (cameraMain == null) {
                            Debug.LogError("No valid cameras found in scene! Make sure there's at least one active camera and check its culling mask is including Terrain Grid System.");
                        }
                    }
                }
            }
