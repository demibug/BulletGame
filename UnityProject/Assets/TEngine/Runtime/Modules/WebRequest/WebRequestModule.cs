...
namespace TEngine
{
    ...
    public sealed class WebRequestModule : Module
    {
        ...
        #region 事件id
        public static readonly int WebRequestEventStart = RuntimeId.ToRuntimeId("WebRequestEventStart");
        public static readonly int WebRequestEventSuccess = RuntimeId.ToRuntimeId("WebRequestEventSuccess");
        public static readonly int WebRequestEventFailure = RuntimeId.ToRuntimeId("WebRequestEventFailure");
        ...
        protected override void Awake()
        {
            ...
            m_webRequestManager = ModuleImpSystem.GetModule<IWebRequestManager>();
        ...
        {
            GameEvent.Send(WebRequestEventStart, e);
        }

        private void OnWebRequestSuccess(object sender, WebRequestSuccessEventArgs e)
        {
            GameEvent.Send(WebRequestEventSuccess, e);
        }
        ...
        private void OnWebRequestFailure(object sender, WebRequestFailureEventArgs e)
        {
            ...
            GameEvent.Send(WebRequestEventFailure, e);
        }
    }
}