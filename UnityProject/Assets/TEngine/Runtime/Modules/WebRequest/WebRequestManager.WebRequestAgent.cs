...
namespace TEngine
{
    internal sealed partial class WebRequestManager : ModuleImp, IWebRequestManager
    {
        /// <summary>
        /// Web 请求代理。
        /// </summary>
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public Action<WebRequestAgent, byte[]> WebRequestAgentComplete;
            ...
            public StartTaskStatus Start(WebRequestTask task)
            {
                ...
                {
                    if (m_Task.Tag == "protobuf")
                    {
                        m_Helper.RequestProtobuf(m_Task.WebRequestUri, postData, m_Task.UserData);
                    }
                    else
                    {
            ...
            private void OnWebRequestAgentHelperComplete(object sender, WebRequestAgentHelperCompleteEventArgs e)
            {
                ...
                if (WebRequestAgentComplete != null)
                {
                    WebRequestAgentComplete(this, e.GetWebResponseBytes());
                }
