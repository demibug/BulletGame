...
namespace TEngine
{
    ...
    public sealed class NetworkErrorEventArgs : GameFrameworkEventArgs
    {
        ...
        {
            NetworkChannel = null;
            ErrorCode = NetworkManagerErrorCode.Unknown;
        ...
        /// 获取错误码。
        /// </summary>
        public NetworkManagerErrorCode ErrorCode
        {
            get;
            private set;
        }
        ...
        public static NetworkErrorEventArgs Create(INetworkChannel networkChannel, NetworkManagerErrorCode errorCode, SocketError socketErrorCode, string errorMessage)
        {
